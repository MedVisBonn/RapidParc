...
def main():
    ...
    parser.add_argument("--slicer_licence_consent_given", action="store_true", help="Whether you do agree to the slicer licence.")
    ...
    test(model_name_or_path=args.model_name_or_path,
         ...
         slicer_licence_consent_given=args.slicer_licence_consent_given
    )